...
namespace Feezbow.Infrastructure.Migrations
{
    ...
    [Migration("20260629145529_AddAIInsights")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Feezbow.Domain.Entities.AIInsight", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("ProjectId", "DismissedAt");
            ...
            modelBuilder.Entity("Feezbow.Domain.Entities.AiAuditLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<DateTimeOffset?>("FeedbackReceivedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Feezbow.Domain.Entities.Attachment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Feezbow.Domain.Entities.Bill", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Feezbow.Domain.Entities.BillSplit", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Feezbow.Domain.Entities.HouseholdChore", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("HouseholdChore");
                });

            modelBuilder.Entity("Feezbow.Domain.Entities.HouseholdEvent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("HouseholdEvents");
                });

            modelBuilder.Entity("Feezbow.Domain.Entities.HouseholdProfile", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Feezbow.Domain.Entities.Label", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Feezbow.Domain.Entities.MealPlan", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Feezbow.Domain.Entities.MealPlanItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("AssignedCookId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Feezbow.Domain.Entities.Notification", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Feezbow.Domain.Entities.ShoppingListItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Feezbow.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<string>("EmailConfirmationRequestIpAddress")
                        .HasColumnType("text");

                    b.Property<DateTime?>("EmailConfirmationRequestedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<string>("PasswordResetRequestIpAddress")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Feezbow.Domain.Entities.Bill", b =>
                {
                    b.HasOne("Feezbow.Domain.Entities.Bill", "ParentBill")
                        .WithMany()
            ...
            modelBuilder.Entity("Feezbow.Domain.Entities.BillSplit", b =>
                {
                    b.HasOne("Feezbow.Domain.Entities.Bill", null)
                        .WithMany("Splits")
                        .HasForeignKey("BillId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Feezbow.Domain.Entities.BoardTaskLabel", b =>
                {
                    b.HasOne("Feezbow.Domain.Entities.Label", "Label")
                        .WithMany()
            ...
            modelBuilder.Entity("Feezbow.Domain.Entities.HouseholdChore", b =>
                {
                    b.HasOne("Feezbow.Domain.Entities.User", "AssignedTo")
                        .WithMany()
                    ...
                    b.OwnsOne("Feezbow.Domain.ValueObjects.RecurrenceRule", "Recurrence", b1 =>
                        {
                            b1.Property<long>("HouseholdChoreId")
                                .HasColumnType("bigint");
                            ...
                            b1.HasKey("HouseholdChoreId");

                            b1.ToTable("HouseholdChore");

                            b1.WithOwner()
                                .HasForeignKey("HouseholdChoreId");
                        });
            ...
            modelBuilder.Entity("Feezbow.Domain.Entities.HouseholdProfile", b =>
                {
                    b.HasOne("Feezbow.Domain.Entities.Project", "Project")
                        .WithOne()
                        .HasForeignKey("Feezbow.Domain.Entities.HouseholdProfile", "ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Feezbow.Domain.Entities.MealPlanItem", b =>
                {
                    b.HasOne("Feezbow.Domain.Entities.User", "AssignedCook")
                        .WithMany()
                        .HasForeignKey("AssignedCookId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Feezbow.Domain.Entities.MealPlan", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Feezbow.Domain.Entities.Notification", b =>
                {
                    b.HasOne("Feezbow.Domain.Entities.Project", null)
                        .WithMany()
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Feezbow.Domain.Entities.ShoppingListItem", b =>
                {
                    b.HasOne("Feezbow.Domain.Entities.ShoppingList", null)
                        .WithMany("Items")
